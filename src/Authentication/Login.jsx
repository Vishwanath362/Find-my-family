...
import { Mail, Lock, Eye, EyeOff, MapPin, Shield, Heart, ArrowRight } from 'lucide-react';
 ...
 const handleGoogleLogin = async () => {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center px-4">
      ...
      {/* Login Card */}
      <div className={`relative z-10 w-full max-w-md transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'
        }`}>
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm">Sign in to your family circle</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className={`group w-full py-3 rounded-xl font-semibold text-white transition-all duration-300 ${isLoading
          ...
          <button
            ...
            disabled={isLoading}
            className={`group w-full py-3 rounded-xl font-semibold text-white border border-white/10 transition-all duration-300 ${isLoading
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/signup" className="text-emerald-400 hover:text-emerald-300 font-medium transition-colors duration-300">
                Create one now
              </Link>
            </p>
          </div>
